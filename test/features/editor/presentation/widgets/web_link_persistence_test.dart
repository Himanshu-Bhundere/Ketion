...
void main() {
  ...
  testWidgets('WebLink block persistence and structural round-trip', (tester) async {
    ...
    // Verify WebLink block
    final linkNode = nodesList[0] as KetionWebLinkNode;
    expect(linkNode.url, 'https://example.com');
  });
}
