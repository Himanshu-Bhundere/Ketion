...
void main() {
  ...
  testWidgets('Every exposed slash-menu option has a complete execution pipeline', (tester) async {
    ...
    expect(options.isNotEmpty, isTrue, reason: 'Should expose at least one slash option');
    ...
    for (int i = 0; i < options.length; i++) {
      ...
      if (option is SuperEditorSlashCommandOption) {
        ...
        // Execute the option's requests on the first node
        final requests = option.getEditRequests(firstNodeId);
        ...
        // Verify mutation (node changed type, id, or blockType changed)
        ...
        // Re-pump widget completely to refresh internal editor states
