...
void main() {
  ...
  testWidgets(
      'Table persistence structural round-trip, duplicate-persistence regression, and rapid-edit',
      (tester) async {
    ...
    final tableBlockAfterEdits =
        testBlocks.firstWhere((b) => b.type == 'table');
    ...
    expect(
      reopenedTable.metadata['columnCount'],
      4,
  ...
  testWidgets(
      'SuperEditorAdapter discards generic NodeChangeEvents for KetionTableNode',
      (tester) async {
    final testPage = page_entity.Page(
      id: pageId,
      title: 'Test',
    ...
    expect(blocksUpdatedCount, 0,
        reason:
            'Generic NodeChangeEvent for KetionTableNode must be discarded',);
  });

  testWidgets(
      'Table drag and drop reordering of rows and columns works and persists',
      (tester) async {
    final testPage = page_entity.Page(
      id: pageId,
      title: 'Test',
