...
void main() {
  ...
  testWidgets('Quote persistence and structural round-trip', (tester) async {
    ...
    } else if (quoteOption is SuperEditorSlashCommandOption) {
    ...
    expect(para.metadata['blockType'], blockquoteAttribution);
