...
import 'package:ketion/features/blocks/domain/entities/block.dart'
    as domain_block;
import 'package:ketion/features/media/domain/entities/attachment.dart'
    as domain_attachment;
    ...
    switch (table) {
      ...
      case 'attachments':
        final existing = await (_db.select(_db.attachments)
            ...
            .getSingleOrNull();
        if (existing != null) {
          payload['localPath'] = existing.localPath;
          payload['thumbnailPath'] = existing.thumbnailPath;
          payload['uploadStatus'] = existing.uploadStatus;
          payload['isPinnedOffline'] = existing.isPinnedOffline;
        }
      ...
      case 'collections':
        ...
        await _db
            ...
            .insertOnConflictUpdate(collection.toCompanion());
        break;
      case 'tags':
      ...
      case 'reminders':
        ...
        await _db
            .into(_db.reminders)
            .insertOnConflictUpdate(ReminderMapper.toDbCompanion(reminder));
        break;
      default:
