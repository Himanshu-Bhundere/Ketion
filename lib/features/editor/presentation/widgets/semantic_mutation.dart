...
class IndentBlockMutation extends SemanticMutation {
  final String nodeId;

  const IndentBlockMutation({required this.nodeId});
}

class UnindentBlockMutation extends SemanticMutation {
  final String nodeId;

  const UnindentBlockMutation({required this.nodeId});
}

class ToggleBlockExpandedMutation extends SemanticMutation {
  final String nodeId;
...
class UpdateReminderMutation extends SemanticMutation {
  ...
  const UpdateReminderMutation({required this.nodeId});
}

/// A TableBlock is updated.
/// The complete persisted TableBlock representation has changed.
class UpdateTableMutation extends SemanticMutation {
  final String nodeId;
