...
void main() {
  ...
  testWidgets('Code block persistence and structural round-trip', (tester) async {
    ...
    // Verify Code block
    final codeNode = nodesList[0] as ParagraphNode;
    expect(codeNode.metadata['blockType'], codeAttribution);
    expect(codeNode.metadata['language'], 'dart');
    expect(codeNode.metadata['showLineNumbers'], true);
    expect(codeNode.metadata['wrapLines'], false);
    expect(codeNode.text.toPlainText(), 'void main() {}');
  });
}
