...
void main() {
  ...
  testWidgets('PageLink block persistence and structural round-trip', (tester) async {
    ...
    // Verify PageLink block
    final linkNode = nodesList[0] as KetionPageLinkNode;
    expect(linkNode.pageId, 'linked-page-id-123');
  });
}
