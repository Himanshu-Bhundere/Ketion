...
class AttachmentStorageService {
  ...
  Future<Directory> get _attachmentsDir async {
    ...
    final mediaDir = Directory(p.join(dir.path, 'Attachments'));
  ...
  Future<(String, String?, String)> saveAttachment(File sourceFile, {bool generateThumbnail = false}) async {
    ...
    // e.g., Attachments/ab
    final prefixDir = Directory(p.join(mediaDir.path, prefix));
    ...
    if (generateThumbnail) {
      ...
      thumbnailRelativePath = p.join(prefix, thumbFileName).replaceAll('\\', '/');
