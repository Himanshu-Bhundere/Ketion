...
void main() {
  ...
  testWidgets('Bookmark persistence and structural round-trip', (tester) async {
    ...
    // Verify Bookmark
    final bookmarkNode = nodesList[0] as KetionBookmarkNode;
    expect(bookmarkNode.url, 'https://example.com/bookmark');
  });
}
