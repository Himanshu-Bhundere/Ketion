...
class _ListBlockWidgetState extends ConsumerState<ListBlockWidget> {
  ...
  List<SlashCommandOption> _slashOptionsFor(String query) {
    final options = [
      SlashCommandOption(
        title: 'Heading 1', subtitle: 'Large section heading', icon: Icons.title,
        onSelected: () => _convertToHeading(1),
      ),
      SlashCommandOption(
        title: 'Heading 2', subtitle: 'Medium section heading', icon: Icons.title,
        onSelected: () => _convertToHeading(2),
      ),
      SlashCommandOption(
        title: 'Heading 3', subtitle: 'Small section heading', icon: Icons.title,
        onSelected: () => _convertToHeading(3),
      ),
      SlashCommandOption(
        title: 'Checklist', subtitle: 'Track tasks with a to-do list', icon: Icons.check_box_outlined,
        onSelected: () => _convertToList('checklist'),
      ),
      SlashCommandOption(
        title: 'Bulleted List', subtitle: 'Create a simple bulleted list', icon: Icons.format_list_bulleted,
        onSelected: () => _convertToList('bullet'),
      ),
      SlashCommandOption(
        title: 'Numbered List', subtitle: 'Create a numbered list', icon: Icons.format_list_numbered,
