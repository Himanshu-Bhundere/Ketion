...
void main() {
  ...
  testWidgets('Callout conversion round-trip and ID preservation', (tester) async {
    ...
    expect(data['icon'], '💡');
    expect(data['color'], 'grey');
    expect(data['spans'][0]['text'], 'Current Paragraph');
    ...
    expect(documentReopened.getNodeAt(0) is KetionCalloutNode, isTrue);
    final reopenedCallout = documentReopened.getNodeAt(0) as KetionCalloutNode;
    expect(reopenedCallout.text.toPlainText(), 'Current Paragraph');
