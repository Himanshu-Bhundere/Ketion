...
class _ImageBlockWidgetState extends ConsumerState<ImageBlockWidget> {
  ...
  void _parseData() {
    try {
      ...
      _blockData = const BlockDataModel.image(attachmentId: '') as ImageBlockData;
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return attachmentAsync.when(
      data: (attachment) {
        ...
        return Column(
          ...
          children: [
            ...
            if (_blockData.caption != null && _blockData.caption!.isNotEmpty)
              Padding(
      ...
      error: (e, st) => SizedBox(
        height: 100,
        child: Center(child: Text('Error loading image: $e')),
      ),
    );
  }
}
